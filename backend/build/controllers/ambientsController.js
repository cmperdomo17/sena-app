...
class AmbientController {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query(sql, [req.body.ambient_id, req.body.ambient_name, req.body.ambient_location, req.body.ambient_type, req.body.ambient_capacity]);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query(sql, [req.params.id, req.body.ambient_name, req.body.ambient_location, req.body.ambient_type, req.body.ambient_capacity]);
